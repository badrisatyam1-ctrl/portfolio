...
export const WORKBENCH_ARSENAL: ArsenalItem[] = [
  {
    ...
    description: "The core brains behind my embedded projects, like the Smart Helmet's accident detection logic and real-time sensor processing.",
    skills: ["C/C++", "FreeRTOS", "Wi-Fi/Bluetooth", "IoT protocols"],
  },
  {
    id: "lidar-imu",
    name: "IMU & Spatial Sensors",
    category: "Sensors & Actuators",
    description: "MPU6050 gyroscopes and accelerometers utilized heavily in my experimental Drone System for PID-controlled flight stabilization.",
    skills: ["Sensor Fusion", "Kalman Filters", "I2C/SPI"],
  },
  {
    id: "env-sensors",
    name: "Safety & Environment",
    category: "Sensors & Actuators",
    description: "MQ-3 alcohol sensors and IR detectors used to build compliance and safety verification gates in embedded products.",
  ...
  },
  {
    ...
    description: "Deep learning frameworks I use to train Convolutional Neural Networks, specifically for complex computer vision tasks like Semiconductor Wafer Defect Classification.",
  ...
  },
  {
    ...
    category: "AI & ML Frameworks",
    description: "Pandas, NumPy, and scikit-learn used for aggressive data preprocessing, exploratory data analysis, and handling severe class imbalances.",
  ...
  },
  {
    ...
    description: "Hands-on experience soldering surface-mount components, designing custom PCBs, and debugging circuits with multimeters for physical prototypes.",
