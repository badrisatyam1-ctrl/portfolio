...
export default function NotesList({ notes }: { notes: NoteMetadata[] }) {
  return (
        ...
        >
          ...
          >
            ...
            <div className="mt-4 flex sm:mt-0 sm:ml-6 sm:flex-col sm:items-end">
              <div className="flex h-10 w-10 items-center justify-center rounded-full border border-border/50 bg-bg text-faint transition-colors group-hover:border-accent group-hover:bg-accent/10 group-hover:text-accent">
                <BookOpen size={16} />
              </div>
            </div>
          </Link>
